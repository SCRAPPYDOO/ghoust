...
float const MovementHelper::pointDegree = 0.78f;

float MovementHelper::findDirection(Position* characterPosition, Position* targetPosition) {
...
float MovementHelper::findRange(Position* characterPosition, Position* targetPosition) {
	float x1 = characterPosition->posX;
	float y1 = characterPosition->posY;
	float x2 = targetPosition->posX;
	float y2 = targetPosition->posY;
